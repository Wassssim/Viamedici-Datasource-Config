...
export const getProductAndSystemhierarchies =   {
                                                   "query": {
                                                        "bool": {
                                                                "should": [
                                                                                {"wildcard": {"hierarchyShortcut": {"value": "","case_insensitive": true}}},            
                                                                                {"wildcard": {"hierarchyNameDeuDeu": {"value": "","case_insensitive": true}}},
                                                                                {"wildcard": {"hierarchyNameEngGlo": {"value": "","case_insensitive": true}}}
                                                                          ],
                                                                "must":   [
                                                                          ],
